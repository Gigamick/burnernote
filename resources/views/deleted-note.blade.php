...
@section('content')
    <div class="max-w-md mx-auto px-4 sm:px-6 text-center">
        ...
        <h2 class="text-xl font-bold text-gray-900 mb-2">Note not found</h2>
        <p class="text-gray-500 mb-8">The note you're trying to access has expired or has already been viewed.</p>
